...
impl Random {
    /// Constructs a `Random`, initialized with a default seed.
    ///
    /// Corresponds to the default initialization in [`genrand_int32`](https://github.com/thaliaarchi/mt19937-archive/blob/mt19937ar-2002/mt19937ar.c#L111-L112).
    #[inline]
    pub fn new() -> Self {
        Random::from_u32(5489)
    }

    /// Constructs a `Random`, initialized with a seed.
    ///
